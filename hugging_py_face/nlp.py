...
class NLP(BaseAPI):
    ...
    def translation(self, text: Union[Text, List], lang_input: Text = None, lang_output: Text = None, options: Optional[Dict] = None, model: Optional[Text] = None) -> Union[Dict, List]:
        ...
        :param lang_input: the short code of the language of the input text. This parameter is mandatory if either the model is not provided or the model is one of the Helsinki-NLP/opus-mt models.
        :param lang_output: the short code of the language to translate the input text to. This parameter is mandatory if either the model is not provided or the model is one of the Helsinki-NLP/opus-mt models.
